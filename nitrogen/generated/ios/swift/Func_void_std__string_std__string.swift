...
/**
 * Wraps a Swift `(_ triggerId: String, _ emoji: String) -> Void` as a class.
...
public final class Func_void_std__string_std__string {
  ...
  private let closure: (_ triggerId: String, _ emoji: String) -> Void

  public init(_ closure: @escaping (_ triggerId: String, _ emoji: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(triggerId: std.string, emoji: std.string) -> Void {
    self.closure(String(triggerId), String(emoji))
  }
