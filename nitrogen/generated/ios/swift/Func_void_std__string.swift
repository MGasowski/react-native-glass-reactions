...
/**
 * Wraps a Swift `(_ triggerId: String) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_std__string {
  public typealias bridge = margelo.nitro.glassreactions.bridge.swift

  private let closure: (_ triggerId: String) -> Void

  public init(_ closure: @escaping (_ triggerId: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(triggerId: std.string) -> Void {
    self.closure(String(triggerId))
  }
