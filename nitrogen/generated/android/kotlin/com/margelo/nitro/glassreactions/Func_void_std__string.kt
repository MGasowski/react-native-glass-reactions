...
/**
 * Represents the JavaScript callback `(triggerId: string) => void`.
...
fun interface Func_void_std__string: (String) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(triggerId: String): Unit
}
...
class Func_void_std__string_cxx: Func_void_std__string {
  ...
  @Keep
  override fun invoke(triggerId: String): Unit
    = invoke_cxx(triggerId)

  private external fun invoke_cxx(triggerId: String): Unit
}
...
class Func_void_std__string_java(private val function: (String) -> Unit): Func_void_std__string {
  ...
  @Keep
  override fun invoke(triggerId: String): Unit {
    return this.function(triggerId)
  }
}
